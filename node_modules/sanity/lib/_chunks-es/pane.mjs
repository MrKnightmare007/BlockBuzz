...
import { Box, rem, Flex, Inline, Text, useToast, Stack, Card, Layer, BoundaryElementProvider, MenuDivider, Menu, TextSkeleton, rgba, useElementRect, LayerProvider, Button as Button$1, MenuItem as MenuItem$1, Container as Container$1, DialogProvider, PortalProvider, _raf2, TextInput, Code, TabList, TabPanel, Heading, Spinner, focusFirstDescendant, usePortal, Popover, useLayer, useGlobalKeyDown, useClickOutsideEvent, Grid as Grid$2, Dialog as Dialog$1, Badge, AvatarStack, Skeleton, Checkbox, Select } from "@sanity/ui";
...
import { PaneRouterContext, PaneLayoutContext, PaneContext, ConnectorContext, ReferenceInputOptionsContext, DocumentPaneContext, StructureToolContext, DocumentSheetListContext, DocumentChangeContext } from "sanity/_singletons";
import { InfoOutlineIcon, DocumentsIcon, ChevronDownIcon, CopyIcon, UnknownIcon, WarningOutlineIcon, CheckmarkIcon, AddIcon, ChevronRightIcon, DocumentIcon, FolderIcon, TransferIcon, CloseIcon, LockIcon, SearchIcon, DocumentRemoveIcon, ReadOnlyIcon, ErrorOutlineIcon, SyncIcon, UnpublishIcon, TrashIcon, ResetIcon, RevertIcon, PublishIcon, ArrowLeftIcon, SplitVerticalIcon, EditIcon, ChevronLeftIcon, RestoreIcon, LinkIcon, EarthAmericasIcon, JsonIcon, SpinnerIcon, EllipsisHorizontalIcon, DoubleChevronLeftIcon, DoubleChevronRightIcon, SortIcon, StackCompactIcon, StackIcon, CheckmarkCircleIcon, MasterDetailIcon } from "@sanity/icons";
import camelCase from "lodash/camelCase.js";
import speakingurl from "speakingurl";
import uniqueId from "lodash/uniqueId.js";
import { isValidElementType } from "react-is";
import { defineLocaleResourceBundle, useSchema, useTranslation, unstable_useValuePreview, useDocumentVersionInfo, usePerspective, getPreviewStateObservable, getPreviewValueWithFallback, SanityDefaultPreview, DocumentPreviewPresence, DocumentStatusIndicator, DocumentStatus, useUnique, getPublishedId, useDocumentPresence, useDocumentPreviewStore, PreviewCard, Translate, createHookFromObservableFactory, getDraftId, useClient, DEFAULT_STUDIO_CLIENT_OPTIONS, useDocumentStore, LoadingBlock, LegacyLayerProvider, IsLastPaneProvider, useGetI18nText, useI18nText, TooltipOfDisabled, ContextMenuButton, StatusButton, useCurrentUser, InsufficientPermissionsMessage, useTemplates, useIsReleaseActive, useTemplatePermissions, EMPTY_OBJECT, EMPTY_ARRAY as EMPTY_ARRAY$2, useEditState, GetHookCollectionState, useDocumentVersions, useActiveReleases, getVersionFromId, getReleaseIdFromReleaseDocumentId, isPublishedId, isDraftId, getVersionId, ReleaseAvatar, getReleaseTone, formatRelativeLocalePublishDate, isReleaseScheduledOrScheduling, isReleaseDocument, useDocumentForm, ChangeIndicatorsTracker, VirtualizerScrollInstanceProvider, isVersionId, createPatchChannel, FormBuilder, isDev, CommentsEnabledProvider, useCommentsEnabled, CommentsProvider, COMMENTS_INSPECTOR_NAME, useArchivedReleases, useDocumentOperationEvent, Resizable, useKeyValueStore, isRecord, isString, isPublishedPerspective, isDraftPerspective, useDocumentOperation, isDeprecatedSchemaType, useProjectId, useZIndex, useListFormat, LATEST, useVersionOperations, getVersionInlineBadge, isGoingToUnpublish, PresenceOverlay, fromMutationPatches, ScrollContainer, useDocumentPairPermissions, useValidationStatus, useSyncState, useRelativeTime, useSource, Hotkeys, useSetPerspective, useDateTimeFormat, VersionChip, useFieldActions, UserAvatar, useUser, AvatarSkeleton, CommandList, TextWithTone, useTimelineSelector, useEvents, TIMELINE_ITEM_I18N_KEY_MAPPING as TIMELINE_ITEM_I18N_KEY_MAPPING$1, resizeObserver, useSanityCreateConfig, isSanityCreateLinked, ChangeConnectorRoot, getSanityCreateLinkMetadata, useGlobalCopyPasteElementHandler, GetFormValueProvider, FieldActionsResolver, FieldActionsProvider, useMiddlewareComponents, useInitialValue, useCopyPaste, useEventsStore, EventsProvider, isDeleteDocumentGroupEvent, isDeleteDocumentVersionEvent, PerspectiveProvider, useTimelineStore, SourceProvider, CopyPasteProvider, useDocumentType, ReferenceInputOptionsProvider, ErrorActions, collate, createSWR, getSearchableTypes, createSearch, useWorkspace, useSearchMaxFieldDepth, useSearchState, SearchHeader, Filters, SearchProvider, getConfigContextFromSource, ChangeFieldWrapper, NoChanges, ChangeList, isUnpublishDocumentEvent, isScheduleDocumentVersionEvent, isUnscheduleDocumentVersionEvent, Event, VersionInlineBadge, RELEASES_INTENT, isCreateDocumentVersionEvent, isEditDocumentVersionEvent, getDocumentVariantType, isPublishDocumentVersionEvent, ChangesError, isArray, isValidationError, isValidationWarning, definePlugin, useConfigContextFromSource } from "sanity";
...
function PaneItemPreview(props) {
  ...
  let t2;
  $[3] !== props.documentPreviewStore || $[4] !== schemaType || $[5] !== t1 || $[6] !== value._id ? (t2 = getPreviewStateObservable(props.documentPreviewStore, schemaType, value._id, t1), $[3] = props.documentPreviewStore, $[4] = schemaType, $[5] = t1, $[6] = value._id, $[7] = t2) : t2 = $[7], t0 = t2;
  ...
  let t4;
  $[9] !== isLoading || $[10] !== presence || $[11] !== versionsInfo.draft || $[12] !== versionsInfo.published || $[13] !== versionsInfo.versions ? (t4 = isLoading ? null : /* @__PURE__ */ jsx(TooltipDelayGroupProvider, { children: /* @__PURE__ */ jsxs(Flex, { align: "center", gap: 3, children: [
  ...
  const status = t4;
  let t5;
  $[15] !== versionsInfo.draft || $[16] !== versionsInfo.published || $[17] !== versionsInfo.versions ? (t5 = /* @__PURE__ */ jsx(DocumentStatus, { draft: versionsInfo.draft, published: versionsInfo.published, versions: versionsInfo.versions }), $[15] = versionsInfo.draft, $[16] = versionsInfo.published, $[17] = versionsInfo.versions, $[18] = t5) : t5 = $[18];
  const tooltip = t5;
  let t6;
  ...
  let t7;
  return $[22] !== icon || $[23] !== isLoading || $[24] !== layout || $[25] !== status || $[26] !== t6 || $[27] !== tooltip ? (t7 = /* @__PURE__ */ jsx(SanityDefaultPreview, { ...t6, isPlaceholder: isLoading, icon, layout, status, tooltip }), $[22] = icon, $[23] = isLoading, $[24] = layout, $[25] = status, $[26] = t6, $[27] = tooltip, $[28] = t7) : t7 = $[28], t7;
}
...
`, VersionModeHeader = ({
  ...
  return /* @__PURE__ */ jsx(MenuItem$1, { padding: 1, paddingRight: 3, onClick, pressed: isSelected, children: /* @__PURE__ */ jsxs(Flex, { gap: 1, children: [
    ...
    /* @__PURE__ */ jsxs(Stack, { flex: 1, paddingY: 2, paddingRight: 2, space: 2, children: [
      /* @__PURE__ */ jsx(Text, { size: 1, weight: "medium", children: release.metadata.title }),
...
`, DiffViewPane = forwardRef(function(t0, ref) {
  ...
  const t18 = t17;
  let t19;
  $[45] !== collapsedFieldSets || $[46] !== collapsedPaths || $[47] !== formState || $[48] !== isLoading || $[49] !== onBlur || $[50] !== onChange || $[51] !== onFocus || $[52] !== onPathOpen || $[53] !== onSetActiveFieldGroup || $[54] !== onSetCollapsedFieldSet || $[55] !== onSetCollapsedPath || $[56] !== patchChannel || $[57] !== role || $[58] !== schemaType || $[59] !== value ? (t19 = /* @__PURE__ */ jsx(DialogProvider, { position: "absolute", children: isLoading ? /* @__PURE__ */ jsx(LoadingBlock, { showText: !0 }) : /* @__PURE__ */ jsx(Container, { ref: containerElement, padding: 4, width: 1, children: /* @__PURE__ */ jsx(FormBuilder, { __internal_patchChannel: patchChannel, id: `diffView-pane-${role}`, onChange, onPathFocus: onFocus, onPathOpen, onPathBlur: onBlur, onFieldGroupSelect: onSetActiveFieldGroup, onSetFieldSetCollapsed: onSetCollapsedFieldSet, onSetPathCollapsed: onSetCollapsedPath, collapsedPaths, collapsedFieldSets, focusPath: formState.focusPath, changed: formState.changed, focused: formState.focused, groups: formState.groups, validation: formState.validation, members: formState.members, presence: formState.presence, schemaType, value }) }) }), $[45] = collapsedFieldSets, $[46] = collapsedPaths, $[47] = formState, $[48] = isLoading, $[49] = onBlur, $[50] = onChange, $[51] = onFocus, $[52] = onPathOpen, $[53] = onSetActiveFieldGroup, $[54] = onSetCollapsedFieldSet, $[55] = onSetCollapsedPath, $[56] = patchChannel, $[57] = role, $[58] = schemaType, $[59] = value, $[60] = t19) : t19 = $[60];
  let t20;
  $[61] !== portalElement || $[62] !== t19 ? (t20 = /* @__PURE__ */ jsx(PortalProvider, { element: portalElement, children: t19 }), $[61] = portalElement, $[62] = t19, $[63] = t20) : t20 = $[63];
  let t21;
  $[64] !== ref || $[65] !== t18 || $[66] !== t20 ? (t21 = /* @__PURE__ */ jsx(Scroller$5, { ref, style: t18, children: t20 }), $[64] = ref, $[65] = t18, $[66] = t20, $[67] = t21) : t21 = $[67];
  let t22;
  $[68] === Symbol.for("react.memo_cache_sentinel") ? (t22 = /* @__PURE__ */ jsx("div", { "data-testid": "diffView-document-panel-portal", ref: setPortalElement }), $[68] = t22) : t22 = $[68];
  let t23;
  $[69] !== t14 || $[70] !== t15 || $[71] !== t21 ? (t23 = /* @__PURE__ */ jsxs(DiffViewPaneLayout, { ref: setBoundaryElement, style: t14, borderLeft: t15, children: [
    t21,
    t22
  ] }), $[69] = t14, $[70] = t15, $[71] = t21, $[72] = t23) : t23 = $[72];
  let t24;
  $[73] !== boundaryElement || $[74] !== t23 ? (t24 = /* @__PURE__ */ jsx(BoundaryElementProvider, { element: boundaryElement, children: t23 }), $[73] = boundaryElement, $[74] = t23, $[75] = t24) : t24 = $[75];
  let t25;
  return $[76] !== scrollElement || $[77] !== t24 ? (t25 = /* @__PURE__ */ jsx(ConnectorContext.Provider, { value: t11, children: /* @__PURE__ */ jsx(ChangeIndicatorsTracker, { children: /* @__PURE__ */ jsx(VirtualizerScrollInstanceProvider, { scrollElement, containerElement, children: t24 }) }) }), $[76] = scrollElement, $[77] = t24, $[78] = t25) : t25 = $[78], t25;
});
...
const _DEBUG = !1, EMPTY_PARAMS$2 = Object.freeze({}), LOADING_PANE = Symbol("LOADING_PANE"), DOCUMENT_PANEL_PORTAL_ELEMENT = "documentPanelPortalElement";
...
const DocumentBox = styled(Box)({
  ...
  bb1: {
    ...
    $[46] === Symbol.for("react.memo_cache_sentinel") ? (t132 = /* @__PURE__ */ jsx(ReferenceChangedBanner, {}), t142 = /* @__PURE__ */ jsx(DeprecatedDocumentTypeBanner, {}), t15 = /* @__PURE__ */ jsx(DeletedDocumentBanners, {}), t16 = /* @__PURE__ */ jsx(UnpublishedDocumentBanner, {}), $[46] = t132, $[47] = t142, $[48] = t15, $[49] = t16) : (t132 = $[46], t142 = $[47], t15 = $[48], t16 = $[49]);
    let t17;
    $[50] !== t122 ? (t17 = /* @__PURE__ */ jsxs(Fragment, { children: [
      t122,
      t132,
      t142,
      t15,
  ...
  let t13;
  $[63] !== documentId || $[64] !== rootElement || $[65] !== schemaType || $[66] !== showInspector ? (t13 = showInspector && /* @__PURE__ */ jsx(BoundaryElementProvider, { element: rootElement, children: /* @__PURE__ */ jsx(DocumentInspectorPanel, { documentId, documentType: schemaType.name, flex: 1 }) }), $[63] = documentId, $[64] = rootElement, $[65] = schemaType, $[66] = showInspector, $[67] = t13) : t13 = $[67];
  let t14;
  return $[68] !== t12 || $[69] !== t13 ? (t14 = /* @__PURE__ */ jsx(PaneContent, { children: /* @__PURE__ */ jsxs(Flex, { height: "fill", children: [
    t12,
    t13
...
const TooltipContent$1 = (t0) => {
  ...
  }, [setPerspective]), schemaType = schema.get(documentType), isLiveEdit = schemaType ? isLiveEditEnabled(schemaType) : !1, isPublishedChipDisabled = useMemo(() => isLiveEdit && !selectedReleaseId ? !1 : !editState?.published, [isLiveEdit, selectedReleaseId, editState?.published]), getReleaseChipState = useCallback((release) => {
  ...
  return /* @__PURE__ */ jsxs(TooltipDelayGroupProvider, { children: [
    /* @__PURE__ */ jsx(Card, { hidden: collapsed, style: {
      ...
      /* @__PURE__ */ jsx(Flex, { flex: 1, gap: 1, padding: 3, paddingBottom: 0, style: {
        overflowX: "scroll"
