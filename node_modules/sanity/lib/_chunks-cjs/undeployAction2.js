...
async function undeployStudioAction(_, context) {
  const {
    apiClient,
    chalk,
    output,
  ...
  if (spinner.succeed(), !userApplication) {
    output.print("Your project has not been assigned a studio hostname"), output.print("or you do not have studioHost set in sanity.cli.js or sanity.cli.ts."), output.print("Nothing to undeploy.");
    return;
  }
  output.print("");
