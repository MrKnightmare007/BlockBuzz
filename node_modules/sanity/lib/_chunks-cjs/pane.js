...
function PaneItemPreview(props) {
  ...
  let t2;
  $[3] !== props.documentPreviewStore || $[4] !== schemaType || $[5] !== t1 || $[6] !== value._id ? (t2 = sanity.getPreviewStateObservable(props.documentPreviewStore, schemaType, value._id, t1), $[3] = props.documentPreviewStore, $[4] = schemaType, $[5] = t1, $[6] = value._id, $[7] = t2) : t2 = $[7], t0 = t2;
  ...
  } = reactRx.useObservable(previewStateObservable, t3), isLoading = previewIsLoading;
  let t4;
  $[9] !== isLoading || $[10] !== presence || $[11] !== versionsInfo.draft || $[12] !== versionsInfo.published || $[13] !== versionsInfo.versions ? (t4 = isLoading ? null : /* @__PURE__ */ jsxRuntime.jsx(TooltipDelayGroupProvider.TooltipDelayGroupProvider, { children: /* @__PURE__ */ jsxRuntime.jsxs(ui.Flex, { align: "center", gap: 3, children: [
  ...
  const status = t4;
  let t5;
  $[15] !== versionsInfo.draft || $[16] !== versionsInfo.published || $[17] !== versionsInfo.versions ? (t5 = /* @__PURE__ */ jsxRuntime.jsx(sanity.DocumentStatus, { draft: versionsInfo.draft, published: versionsInfo.published, versions: versionsInfo.versions }), $[15] = versionsInfo.draft, $[16] = versionsInfo.published, $[17] = versionsInfo.versions, $[18] = t5) : t5 = $[18];
  const tooltip = t5;
  let t6;
  $[19] !== original || $[20] !== snapshot ? (t6 = sanity.getPreviewValueWithFallback({
    document,
    snapshot,
    original
  }), $[19] = original, $[20] = snapshot, $[21] = t6) : t6 = $[21];
  let t7;
  return $[22] !== icon || $[23] !== isLoading || $[24] !== layout || $[25] !== status || $[26] !== t6 || $[27] !== tooltip ? (t7 = /* @__PURE__ */ jsxRuntime.jsx(sanity.SanityDefaultPreview, { ...t6, isPlaceholder: isLoading, icon, layout, status, tooltip }), $[22] = icon, $[23] = isLoading, $[24] = layout, $[25] = status, $[26] = t6, $[27] = tooltip, $[28] = t7) : t7 = $[28], t7;
}
...
`, VersionModeHeader = ({
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(ui.MenuItem, { padding: 1, paddingRight: 3, onClick, pressed: isSelected, children: /* @__PURE__ */ jsxRuntime.jsxs(ui.Flex, { gap: 1, children: [
    ...
    /* @__PURE__ */ jsxRuntime.jsxs(ui.Stack, { flex: 1, paddingY: 2, paddingRight: 2, space: 2, children: [
      /* @__PURE__ */ jsxRuntime.jsx(ui.Text, { size: 1, weight: "medium", children: release.metadata.title }),
...
`, DiffViewPane = React.forwardRef(function(t0, ref) {
  ...
  const t18 = t17;
  let t19;
  $[45] !== collapsedFieldSets || $[46] !== collapsedPaths || $[47] !== formState || $[48] !== isLoading || $[49] !== onBlur || $[50] !== onChange || $[51] !== onFocus || $[52] !== onPathOpen || $[53] !== onSetActiveFieldGroup || $[54] !== onSetCollapsedFieldSet || $[55] !== onSetCollapsedPath || $[56] !== patchChannel || $[57] !== role || $[58] !== schemaType || $[59] !== value ? (t19 = /* @__PURE__ */ jsxRuntime.jsx(ui.DialogProvider, { position: "absolute", children: isLoading ? /* @__PURE__ */ jsxRuntime.jsx(sanity.LoadingBlock, { showText: !0 }) : /* @__PURE__ */ jsxRuntime.jsx(Container, { ref: containerElement, padding: 4, width: 1, children: /* @__PURE__ */ jsxRuntime.jsx(sanity.FormBuilder, { __internal_patchChannel: patchChannel, id: `diffView-pane-${role}`, onChange, onPathFocus: onFocus, onPathOpen, onPathBlur: onBlur, onFieldGroupSelect: onSetActiveFieldGroup, onSetFieldSetCollapsed: onSetCollapsedFieldSet, onSetPathCollapsed: onSetCollapsedPath, collapsedPaths, collapsedFieldSets, focusPath: formState.focusPath, changed: formState.changed, focused: formState.focused, groups: formState.groups, validation: formState.validation, members: formState.members, presence: formState.presence, schemaType, value }) }) }), $[45] = collapsedFieldSets, $[46] = collapsedPaths, $[47] = formState, $[48] = isLoading, $[49] = onBlur, $[50] = onChange, $[51] = onFocus, $[52] = onPathOpen, $[53] = onSetActiveFieldGroup, $[54] = onSetCollapsedFieldSet, $[55] = onSetCollapsedPath, $[56] = patchChannel, $[57] = role, $[58] = schemaType, $[59] = value, $[60] = t19) : t19 = $[60];
  let t20;
  $[61] !== portalElement || $[62] !== t19 ? (t20 = /* @__PURE__ */ jsxRuntime.jsx(ui.PortalProvider, { element: portalElement, children: t19 }), $[61] = portalElement, $[62] = t19, $[63] = t20) : t20 = $[63];
  let t21;
  $[64] !== ref || $[65] !== t18 || $[66] !== t20 ? (t21 = /* @__PURE__ */ jsxRuntime.jsx(Scroller$5, { ref, style: t18, children: t20 }), $[64] = ref, $[65] = t18, $[66] = t20, $[67] = t21) : t21 = $[67];
  let t22;
  $[68] === Symbol.for("react.memo_cache_sentinel") ? (t22 = /* @__PURE__ */ jsxRuntime.jsx("div", { "data-testid": "diffView-document-panel-portal", ref: setPortalElement }), $[68] = t22) : t22 = $[68];
  let t23;
  $[69] !== t14 || $[70] !== t15 || $[71] !== t21 ? (t23 = /* @__PURE__ */ jsxRuntime.jsxs(DiffViewPaneLayout, { ref: setBoundaryElement, style: t14, borderLeft: t15, children: [
    t21,
    t22
  ] }), $[69] = t14, $[70] = t15, $[71] = t21, $[72] = t23) : t23 = $[72];
  let t24;
  $[73] !== boundaryElement || $[74] !== t23 ? (t24 = /* @__PURE__ */ jsxRuntime.jsx(ui.BoundaryElementProvider, { element: boundaryElement, children: t23 }), $[73] = boundaryElement, $[74] = t23, $[75] = t24) : t24 = $[75];
  let t25;
  return $[76] !== scrollElement || $[77] !== t24 ? (t25 = /* @__PURE__ */ jsxRuntime.jsx(_singletons.ConnectorContext.Provider, { value: t11, children: /* @__PURE__ */ jsxRuntime.jsx(sanity.ChangeIndicatorsTracker, { children: /* @__PURE__ */ jsxRuntime.jsx(sanity.VirtualizerScrollInstanceProvider, { scrollElement, containerElement, children: t24 }) }) }), $[76] = scrollElement, $[77] = t24, $[78] = t25) : t25 = $[78], t25;
});
...
const DocumentBox = styledComponents.styled(ui.Box)({
  ...
  bb1: {
    ...
    $[46] === Symbol.for("react.memo_cache_sentinel") ? (t132 = /* @__PURE__ */ jsxRuntime.jsx(ReferenceChangedBanner, {}), t142 = /* @__PURE__ */ jsxRuntime.jsx(DeprecatedDocumentTypeBanner, {}), t15 = /* @__PURE__ */ jsxRuntime.jsx(DeletedDocumentBanners, {}), t16 = /* @__PURE__ */ jsxRuntime.jsx(UnpublishedDocumentBanner, {}), $[46] = t132, $[47] = t142, $[48] = t15, $[49] = t16) : (t132 = $[46], t142 = $[47], t15 = $[48], t16 = $[49]);
    let t17;
    $[50] !== t122 ? (t17 = /* @__PURE__ */ jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [
      t122,
      t132,
      t142,
      t15,
  ...
  let t13;
  $[63] !== documentId || $[64] !== rootElement || $[65] !== schemaType || $[66] !== showInspector ? (t13 = showInspector && /* @__PURE__ */ jsxRuntime.jsx(ui.BoundaryElementProvider, { element: rootElement, children: /* @__PURE__ */ jsxRuntime.jsx(DocumentInspectorPanel, { documentId, documentType: schemaType.name, flex: 1 }) }), $[63] = documentId, $[64] = rootElement, $[65] = schemaType, $[66] = showInspector, $[67] = t13) : t13 = $[67];
  let t14;
  return $[68] !== t12 || $[69] !== t13 ? (t14 = /* @__PURE__ */ jsxRuntime.jsx(PaneContent, { children: /* @__PURE__ */ jsxRuntime.jsxs(ui.Flex, { height: "fill", children: [
    t12,
    t13
...
const TooltipContent$1 = (t0) => {
  ...
  }, [setPerspective]), schemaType = schema.get(documentType), isLiveEdit = schemaType ? isLiveEditEnabled(schemaType) : !1, isPublishedChipDisabled = React.useMemo(() => isLiveEdit && !selectedReleaseId ? !1 : !editState?.published, [isLiveEdit, selectedReleaseId, editState?.published]), getReleaseChipState = React.useCallback((release) => {
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(TooltipDelayGroupProvider.TooltipDelayGroupProvider, { children: [
    /* @__PURE__ */ jsxRuntime.jsx(ui.Card, { hidden: collapsed, style: {
      ...
      /* @__PURE__ */ jsxRuntime.jsx(ui.Flex, { flex: 1, gap: 1, padding: 3, paddingBottom: 0, style: {
        overflowX: "scroll"
      }, children: /* @__PURE__ */ jsxRuntime.jsx(DocumentPerspectiveList, {}) }),
...
function DocumentLayout() {
  const {
    ...
    collapsed: layoutCollapsed
  } = usePaneLayout(), zOffsets = sanity.useZIndex(), createLinkMetadata = sanity.getSanityCreateLinkMetadata(value), {
