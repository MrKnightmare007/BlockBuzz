...
const isInteractive = process.stdout.isTTY && process.env.TERM !== "dumb" && !("CI" in process.env), helpText$B = `
Notes
  Changing the hostname or port number might require a new entry to the CORS-origins allow list.
...
`, appUndeployCommand = {
  ...
  helpText: helpText$z
}, defaultApiVersion$1 = "v2024-02-21", datasetBackupGroup = {
  name: "backup",
  signature: "[COMMAND]",
