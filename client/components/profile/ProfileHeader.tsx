...
const style = {
    ...
    profileImage: `object-cover rounded-full h-full border-2 border-[#15202B]`,
...
const ProfileHeader = () => {
    ...
    const currentAccount = '0xd9eCAcA55e36269CCa917228751e0Cc322b5218D';
        ...
        <div className={style.wrapper}>
            <div className={style.header}>
                ...
                <div className={style.details}>
                    <div className={style.primary}>Soumyadipta Das</div>
                    <div className={style.secondary}>7 Tweets</div>
                </div>
            </div>
            <div className={style.coverPhotoContainer}>
                <img
                    src='https://pbs.twimg.com/profile_banners/1697621015160053760/1707824768/1500x500'
                    alt='Cover Photo'
